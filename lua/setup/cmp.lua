    ...
    cmp.setup({
      ...
      formatting = {
        format = function(entry, vim_item)
          ...
          if entry.source.name == 'lazydev' then
        ...
        comparators = {
          ...
          function(entry1, entry2)
            ...
            if kind1 == types.lsp.CompletionItemKind.Text then
              kind1 = 100
            elseif kind1 == types.lsp.CompletionItemKind.EnumMember then
              kind1 = -1
            elseif kind1 == types.lsp.CompletionItemKind.Snippet then
              kind1 = -2
            end

            if kind2 == types.lsp.CompletionItemKind.Text then
              kind2 = 100
            elseif kind2 == types.lsp.CompletionItemKind.EnumMember then
              kind2 = -1
            elseif kind2 == types.lsp.CompletionItemKind.Snippet then
              kind2 = -2
            end
